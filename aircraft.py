...
class AhrsStratux(LoggingObject):
    ...
    def __init__(
        ...
        self.__stratux_ahrs_cache__ = AircraftDataCache(MAX_STRATUX_AHRS_AGE, "StratuxAhrs", logger)
        self.__avionics_cache__ = AircraftDataCache(MAX_AVIONICS_AGE, "AvionicsAhrs", logger)
