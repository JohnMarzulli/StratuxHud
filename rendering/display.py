...
class Display:
    ...
    def __is_fullscreen_target__(self) -> bool:
        return local_debug.IS_PI and local_debug.IS_LINUX

    def __get_target_screen_mode__(
        self, force_fullscreen: bool, force_software: bool
    ) -> list:
        """
        ...
        screen_mode = (
            pygame.HWACCEL | pygame.constants.RLEACCEL
    ...
    def __get_target_screen_size__(self) -> list:
        if (
            pygame is not None
            and pygame.display is not None
            and pygame.display.get_init() != 0
        ):
    ...
    def __init__(
        self, force_fullscreen: bool = False, force_software: bool = False
    ) -> None:
        """
        ...
        display_mode, is_fullscreen = self.__get_target_screen_mode__(
            force_fullscreen, force_software
        )
